...
-- Started on 2023-04-30 18:02:20 -03
...
SELECT pg_catalog.setval('public.alunos_id_seq', 1309, true);
...
SELECT pg_catalog.setval('public.avaliacoes_id_seq', 923, true);
...
SELECT pg_catalog.setval('public.creditos_id_seq', 200, true);
...
SELECT pg_catalog.setval('public.disciplinas_id_seq', 129, true);
...
SELECT pg_catalog.setval('public.planos_id_seq', 904, true);
...
SELECT pg_catalog.setval('public.presencas_id_seq', 14385, true);
...
-- Completed on 2023-04-30 18:02:20 -03
